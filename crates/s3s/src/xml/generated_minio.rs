...
impl<'xml> DeserializeContent<'xml> for BucketAccelerateStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Enabled" => Ok(Self::from_static(BucketAccelerateStatus::ENABLED)),
            "Suspended" => Ok(Self::from_static(BucketAccelerateStatus::SUSPENDED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for BucketLocationConstraint {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            ...
            "ap-south-1" => Ok(Self::from_static(BucketLocationConstraint::AP_SOUTH_1)),
            "ap-south-2" => Ok(Self::from_static(BucketLocationConstraint::AP_SOUTH_2)),
            "ap-southeast-1" => Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_1)),
            "ap-southeast-2" => Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_2)),
            ...
            "eu-central-2" => Ok(Self::from_static(BucketLocationConstraint::EU_CENTRAL_2)),
            "eu-north-1" => Ok(Self::from_static(BucketLocationConstraint::EU_NORTH_1)),
            "eu-south-1" => Ok(Self::from_static(BucketLocationConstraint::EU_SOUTH_1)),
            "eu-south-2" => Ok(Self::from_static(BucketLocationConstraint::EU_SOUTH_2)),
            "eu-west-1" => Ok(Self::from_static(BucketLocationConstraint::EU_WEST_1)),
            "eu-west-2" => Ok(Self::from_static(BucketLocationConstraint::EU_WEST_2)),
            "eu-west-3" => Ok(Self::from_static(BucketLocationConstraint::EU_WEST_3)),
            ...
            "us-gov-west-1" => Ok(Self::from_static(BucketLocationConstraint::US_GOV_WEST_1)),
            "us-west-1" => Ok(Self::from_static(BucketLocationConstraint::US_WEST_1)),
            "us-west-2" => Ok(Self::from_static(BucketLocationConstraint::US_WEST_2)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for BucketLogsPermission {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "FULL_CONTROL" => Ok(Self::from_static(BucketLogsPermission::FULL_CONTROL)),
            "READ" => Ok(Self::from_static(BucketLogsPermission::READ)),
            "WRITE" => Ok(Self::from_static(BucketLogsPermission::WRITE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for BucketType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Directory" => Ok(Self::from_static(BucketType::DIRECTORY)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for BucketVersioningStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Enabled" => Ok(Self::from_static(BucketVersioningStatus::ENABLED)),
            "Suspended" => Ok(Self::from_static(BucketVersioningStatus::SUSPENDED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ChecksumType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "COMPOSITE" => Ok(Self::from_static(ChecksumType::COMPOSITE)),
            "FULL_OBJECT" => Ok(Self::from_static(ChecksumType::FULL_OBJECT)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for CompressionType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "BZIP2" => Ok(Self::from_static(CompressionType::BZIP2)),
            "GZIP" => Ok(Self::from_static(CompressionType::GZIP)),
            "NONE" => Ok(Self::from_static(CompressionType::NONE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for DataRedundancy {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "SingleAvailabilityZone" => Ok(Self::from_static(DataRedundancy::SINGLE_AVAILABILITY_ZONE)),
            "SingleLocalZone" => Ok(Self::from_static(DataRedundancy::SINGLE_LOCAL_ZONE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for DeleteMarkerReplicationStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(DeleteMarkerReplicationStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(DeleteMarkerReplicationStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for DeleteReplicationStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(DeleteReplicationStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(DeleteReplicationStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for EncodingType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "url" => Ok(Self::from_static(EncodingType::URL)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ExistingObjectReplicationStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(ExistingObjectReplicationStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(ExistingObjectReplicationStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ExpirationStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(ExpirationStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(ExpirationStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ExpressionType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "SQL" => Ok(Self::from_static(ExpressionType::SQL)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for FileHeaderInfo {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "IGNORE" => Ok(Self::from_static(FileHeaderInfo::IGNORE)),
            "NONE" => Ok(Self::from_static(FileHeaderInfo::NONE)),
            "USE" => Ok(Self::from_static(FileHeaderInfo::USE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for FilterRuleName {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "prefix" => Ok(Self::from_static(FilterRuleName::PREFIX)),
            "suffix" => Ok(Self::from_static(FilterRuleName::SUFFIX)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for IntelligentTieringAccessTier {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "ARCHIVE_ACCESS" => Ok(Self::from_static(IntelligentTieringAccessTier::ARCHIVE_ACCESS)),
            "DEEP_ARCHIVE_ACCESS" => Ok(Self::from_static(IntelligentTieringAccessTier::DEEP_ARCHIVE_ACCESS)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for IntelligentTieringStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(IntelligentTieringStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(IntelligentTieringStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for InventoryFormat {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "CSV" => Ok(Self::from_static(InventoryFormat::CSV)),
            "ORC" => Ok(Self::from_static(InventoryFormat::ORC)),
            "Parquet" => Ok(Self::from_static(InventoryFormat::PARQUET)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for InventoryFrequency {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Daily" => Ok(Self::from_static(InventoryFrequency::DAILY)),
            "Weekly" => Ok(Self::from_static(InventoryFrequency::WEEKLY)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for InventoryIncludedObjectVersions {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "All" => Ok(Self::from_static(InventoryIncludedObjectVersions::ALL)),
            "Current" => Ok(Self::from_static(InventoryIncludedObjectVersions::CURRENT)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for InventoryOptionalField {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "BucketKeyStatus" => Ok(Self::from_static(InventoryOptionalField::BUCKET_KEY_STATUS)),
            "ChecksumAlgorithm" => Ok(Self::from_static(InventoryOptionalField::CHECKSUM_ALGORITHM)),
            "ETag" => Ok(Self::from_static(InventoryOptionalField::E_TAG)),
            "EncryptionStatus" => Ok(Self::from_static(InventoryOptionalField::ENCRYPTION_STATUS)),
            ...
            "ObjectLockRetainUntilDate" => Ok(Self::from_static(InventoryOptionalField::OBJECT_LOCK_RETAIN_UNTIL_DATE)),
            "ObjectOwner" => Ok(Self::from_static(InventoryOptionalField::OBJECT_OWNER)),
            "ReplicationStatus" => Ok(Self::from_static(InventoryOptionalField::REPLICATION_STATUS)),
            "Size" => Ok(Self::from_static(InventoryOptionalField::SIZE)),
            "StorageClass" => Ok(Self::from_static(InventoryOptionalField::STORAGE_CLASS)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for LocationType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "AvailabilityZone" => Ok(Self::from_static(LocationType::AVAILABILITY_ZONE)),
            "LocalZone" => Ok(Self::from_static(LocationType::LOCAL_ZONE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for MFADelete {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(MFADelete::DISABLED)),
            "Enabled" => Ok(Self::from_static(MFADelete::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for MFADeleteStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(MFADeleteStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(MFADeleteStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for MetricsStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(MetricsStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(MetricsStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectCannedACL {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "authenticated-read" => Ok(Self::from_static(ObjectCannedACL::AUTHENTICATED_READ)),
            "aws-exec-read" => Ok(Self::from_static(ObjectCannedACL::AWS_EXEC_READ)),
            "bucket-owner-full-control" => Ok(Self::from_static(ObjectCannedACL::BUCKET_OWNER_FULL_CONTROL)),
            "bucket-owner-read" => Ok(Self::from_static(ObjectCannedACL::BUCKET_OWNER_READ)),
            "private" => Ok(Self::from_static(ObjectCannedACL::PRIVATE)),
            "public-read" => Ok(Self::from_static(ObjectCannedACL::PUBLIC_READ)),
            "public-read-write" => Ok(Self::from_static(ObjectCannedACL::PUBLIC_READ_WRITE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectLockEnabled {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Enabled" => Ok(Self::from_static(ObjectLockEnabled::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectLockLegalHoldStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "OFF" => Ok(Self::from_static(ObjectLockLegalHoldStatus::OFF)),
            "ON" => Ok(Self::from_static(ObjectLockLegalHoldStatus::ON)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectLockRetentionMode {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "COMPLIANCE" => Ok(Self::from_static(ObjectLockRetentionMode::COMPLIANCE)),
            "GOVERNANCE" => Ok(Self::from_static(ObjectLockRetentionMode::GOVERNANCE)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectOwnership {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "BucketOwnerEnforced" => Ok(Self::from_static(ObjectOwnership::BUCKET_OWNER_ENFORCED)),
            "BucketOwnerPreferred" => Ok(Self::from_static(ObjectOwnership::BUCKET_OWNER_PREFERRED)),
            "ObjectWriter" => Ok(Self::from_static(ObjectOwnership::OBJECT_WRITER)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectStorageClass {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            ...
            "ONEZONE_IA" => Ok(Self::from_static(ObjectStorageClass::ONEZONE_IA)),
            "OUTPOSTS" => Ok(Self::from_static(ObjectStorageClass::OUTPOSTS)),
            "REDUCED_REDUNDANCY" => Ok(Self::from_static(ObjectStorageClass::REDUCED_REDUNDANCY)),
            "SNOW" => Ok(Self::from_static(ObjectStorageClass::SNOW)),
            "STANDARD" => Ok(Self::from_static(ObjectStorageClass::STANDARD)),
            "STANDARD_IA" => Ok(Self::from_static(ObjectStorageClass::STANDARD_IA)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ObjectVersionStorageClass {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "STANDARD" => Ok(Self::from_static(ObjectVersionStorageClass::STANDARD)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for OwnerOverride {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Destination" => Ok(Self::from_static(OwnerOverride::DESTINATION)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for PartitionDateSource {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "DeliveryTime" => Ok(Self::from_static(PartitionDateSource::DELIVERY_TIME)),
            "EventTime" => Ok(Self::from_static(PartitionDateSource::EVENT_TIME)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for Payer {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "BucketOwner" => Ok(Self::from_static(Payer::BUCKET_OWNER)),
            "Requester" => Ok(Self::from_static(Payer::REQUESTER)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for Permission {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "FULL_CONTROL" => Ok(Self::from_static(Permission::FULL_CONTROL)),
            "READ" => Ok(Self::from_static(Permission::READ)),
            "READ_ACP" => Ok(Self::from_static(Permission::READ_ACP)),
            "WRITE" => Ok(Self::from_static(Permission::WRITE)),
            "WRITE_ACP" => Ok(Self::from_static(Permission::WRITE_ACP)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for Protocol {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "http" => Ok(Self::from_static(Protocol::HTTP)),
            "https" => Ok(Self::from_static(Protocol::HTTPS)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for QuoteFields {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "ALWAYS" => Ok(Self::from_static(QuoteFields::ALWAYS)),
            "ASNEEDED" => Ok(Self::from_static(QuoteFields::ASNEEDED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ReplicaModificationsStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(ReplicaModificationsStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(ReplicaModificationsStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for ReplicationTimeStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(ReplicationTimeStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(ReplicationTimeStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for RestoreRequestType {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "SELECT" => Ok(Self::from_static(RestoreRequestType::SELECT)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for SseKmsEncryptedObjectsStatus {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Disabled" => Ok(Self::from_static(SseKmsEncryptedObjectsStatus::DISABLED)),
            "Enabled" => Ok(Self::from_static(SseKmsEncryptedObjectsStatus::ENABLED)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for StorageClass {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            ...
            "ONEZONE_IA" => Ok(Self::from_static(StorageClass::ONEZONE_IA)),
            "OUTPOSTS" => Ok(Self::from_static(StorageClass::OUTPOSTS)),
            "REDUCED_REDUNDANCY" => Ok(Self::from_static(StorageClass::REDUCED_REDUNDANCY)),
            "SNOW" => Ok(Self::from_static(StorageClass::SNOW)),
            "STANDARD" => Ok(Self::from_static(StorageClass::STANDARD)),
            "STANDARD_IA" => Ok(Self::from_static(StorageClass::STANDARD_IA)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for Tier {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "Bulk" => Ok(Self::from_static(Tier::BULK)),
            "Expedited" => Ok(Self::from_static(Tier::EXPEDITED)),
            "Standard" => Ok(Self::from_static(Tier::STANDARD)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for TransitionStorageClass {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "DEEP_ARCHIVE" => Ok(Self::from_static(TransitionStorageClass::DEEP_ARCHIVE)),
            "GLACIER" => Ok(Self::from_static(TransitionStorageClass::GLACIER)),
            "GLACIER_IR" => Ok(Self::from_static(TransitionStorageClass::GLACIER_IR)),
            "INTELLIGENT_TIERING" => Ok(Self::from_static(TransitionStorageClass::INTELLIGENT_TIERING)),
            "ONEZONE_IA" => Ok(Self::from_static(TransitionStorageClass::ONEZONE_IA)),
            "STANDARD_IA" => Ok(Self::from_static(TransitionStorageClass::STANDARD_IA)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
...
impl<'xml> DeserializeContent<'xml> for Type {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| match s {
            "AmazonCustomerByEmail" => Ok(Self::from_static(Type::AMAZON_CUSTOMER_BY_EMAIL)),
            "CanonicalUser" => Ok(Self::from_static(Type::CANONICAL_USER)),
            "Group" => Ok(Self::from_static(Type::GROUP)),
            _ => Ok(Self::from(s.to_owned())),
        })
    }
}
